...
public class NinjaSelectCategory extends AbstractScene {
	...
	public NinjaSelectCategory(MTApplication mtApplication, String name, String _category) {
		...
		PImage binnenland = mtApplication.loadImage("../data/menu/binnenland.png");
		PImage buitenland = mtApplication.loadImage("../data/menu/buitenland.png");
		PImage sport = mtApplication.loadImage("../data/menu/sport.png");
		PImage cultuur = mtApplication.loadImage("../data/menu/cultuur.png");
		PImage economie = mtApplication.loadImage("../data/menu/economie.png");
		//Hoofdmenu
		...
		MTImageButton binnenlandButton = new MTImageButton(binnenland, mtApp);
		MTImageButton buitenlandButton = new MTImageButton(buitenland, mtApp);
		MTImageButton sportButton = new MTImageButton(sport, mtApp);
		MTImageButton cultuurButton = new MTImageButton(cultuur, mtApp);
		MTImageButton economieButton = new MTImageButton(economie, mtApp);
		...
		binnenlandButton.setNoStroke(true);
		buitenlandButton.setNoStroke(true);
		sportButton.setNoStroke(true);
		cultuurButton.setNoStroke(true);
		economieButton.setNoStroke(true);
		...
		if (MT4jSettings.getInstance().isOpenGlMode()) {
			...
			binnenlandButton.setUseDirectGL(true);
			buitenlandButton.setUseDirectGL(true);
			sportButton.setUseDirectGL(true);
			cultuurButton.setUseDirectGL(true);
			economieButton.setNoStroke(true);
		}
		...
		categoryButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent eCategory) {
				...
				case TapEvent.BUTTON_CLICKED:
					...
					newScene = new NinjaMainMenu(mtApp, "NinjaNieuws", currentCategory);
					mtApp.addScene(newScene);
					mtApp.changeScene(newScene);
					break;
				default:
		...
		binnenlandButton.addActionListener(new ActionListener() {
		...
		buitenlandButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent change) {
				switch(change.getID()) {
				case TapEvent.BUTTON_CLICKED:
					if(mtApp.popScene()) {
		...
		this.getCanvas().addChild(binnenlandButton);
		this.getCanvas().addChild(buitenlandButton);
		...
		binnenlandButton.setPositionGlobal(new Vector3D(mtApp.width - binnenlandButton.getWidthXY(TransformSpace.GLOBAL) / 2 - 315, binnenlandButton.getHeightXY(TransformSpace.GLOBAL) / 2));
		buitenlandButton.setPositionGlobal(new Vector3D(mtApp.width - buitenlandButton.getWidthXY(TransformSpace.GLOBAL) / 2 - 295, buitenlandButton.getHeightXY(TransformSpace.GLOBAL) / 2 + 90));
	}
